...
```
NOTE: The ```dconf()``` confidence interval calculation, originally developed by Arteaga et al. (1982) assumes that score effects are normally distributed. Hence, any attempt to use ```dconf()```with non-normal data will not produce reasonable results!
