...
Or, say you have already decided on the number of trials you wish to use. Continuing from the previous example, let's use n = 2. But now, you want to find the confidence interval for that G-coefficient at the alpha = .1 confidence level. For that, we can use the ```dconf``` function!
```{r}
